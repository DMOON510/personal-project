...
function showCookieRecipe () {
  ...
  var random = Math.random() * 3;
  var rounded = Math.floor(random);
  var cookies = linksCookie[rounded];
  window.open(cookies)
}
...
function showPastriesRecipe () {
  ...
  var random = Math.random() * 3;
  var rounded = Math.floor(random);
  var pastries = linksPastries[rounded];
  window.open(pastries)
}
...
function showChickenRecipe() {
  ...
  var random = Math.random() * 3;
  var rounded = Math.floor(random);
  var chicken = linksChicken[rounded];
  window.open(chicken)
}
...
function showCoffeeRecipe() {
  ...
  var random = Math.random() * 3;
  var rounded = Math.floor(random);
  var coffee = linksCoffee[rounded];
  window.open(coffee)
}
...
submit.on("click", appendRecipes);

function appendRecipes() {
  var name = $('.name').val();
  console.log (name)
  cardContainer.append(`
    <p class="name-card">${name} is a good recipe!</p>
  `);
     $('.name').val("");
}
